...
#include "PxTkNamespaceMangle.h"
	...
	class PxSampleAllocator : public physx::PxAllocatorCallback
	{
		public:
						PxSampleAllocator();
						~PxSampleAllocator();
		...
		protected:
         physx::Ps::MutexT<physx::Ps::RawAllocator> mMutex;

				void**		mMemBlockList;
            physx::PxU32		mMemBlockListSize;
            physx::PxU32		mFirstFree;
            physx::PxU32		mMemBlockUsed;

		public:
         physx::PxI32		mNbAllocatedBytes;
         physx::PxI32		mHighWaterMark;
         physx::PxI32		mTotalNbAllocs;
         physx::PxI32		mNbAllocs;
	};
	...
	class SampleAllocateable
	{
		...
		PX_FORCE_INLINE	void	operator delete		(void* p, physx::PxU32, const char*, int)									{ getSampleAllocator()->deallocate(p);	}
